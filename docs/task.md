...
Hier ist unsere Liste für die Entwicklung von **Medizinis**. Die Aufgaben basieren direkt auf der Roadmap. Unter jedem Punkt findest du den vorbereiteten Commit-Text.
...
- `[ ]` Phase 2: Offline-First Architektur
  ...
  - `[ ]` CRUD-Funktionen für Medikamente inkl. lokaler Beipackzettel-Foto-Speicherung.
    *   **Commit-Notiz:** `feat: add medication CRUD functions and local file system photo picker for leaflets`
  - `[ ]` Implementierung des Refill-Systems (Mengenreduktion und Eulen-Warnungen).
